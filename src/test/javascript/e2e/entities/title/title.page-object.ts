...
export class TitleComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-title div table .btn-danger'));
  title = element.all(by.css('jhi-title div h2#page-heading span')).first();
...
export class TitleUpdatePage {
  pageTitle = element(by.id('jhi-title-heading'));
...
export class TitleDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-title-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-title'));
