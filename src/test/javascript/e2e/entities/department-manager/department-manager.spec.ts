...
describe('DepartmentManager e2e test', () => {
  ...
  it('should create and save DepartmentManagers', async () => {
    ...
    expect(await departmentManagerUpdatePage.getFromDateInput()).to.contain(
      '2001-01-01T02:30',
      'Expected fromDate value to be equals to 2000-12-31'
    );
    expect(await departmentManagerUpdatePage.getToDateInput()).to.contain(
      '2001-01-01T02:30',
    ...
    expect(await departmentManagerComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last DepartmentManager', async () => {
    ...
    expect(await departmentManagerDeleteDialog.getDialogTitle()).to.eq('testDigLabApp.departmentManager.delete.question');
