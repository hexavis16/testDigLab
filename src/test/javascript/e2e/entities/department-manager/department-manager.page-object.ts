...
export class DepartmentManagerComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-department-manager div table .btn-danger'));
  title = element.all(by.css('jhi-department-manager div h2#page-heading span')).first();
...
export class DepartmentManagerUpdatePage {
  pageTitle = element(by.id('jhi-department-manager-heading'));
...
export class DepartmentManagerDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-departmentManager-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-departmentManager'));
