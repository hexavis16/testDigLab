...
import com.diglab.employee.config.audit.AuditEventConverter;
import com.diglab.employee.domain.PersistentAuditEvent;
...
import static com.diglab.employee.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
